<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Chapter3_Lab_Default" Theme="default" %>
<%@ Register Namespace="Solution.Chapter3" TagPrefix="U1" %>
...
<body>
    ...
    <AjaxCTK:TabContainer ID="TC" runat="server" ActiveTabIndex="1">
    <AjaxCTK:TabPanel ID="TP_ListAllProducts" runat="server" HeaderText="List All Products">
    <ContentTemplate>
    <U1:ListProducts ID="GV" runat="server" AllowPaging="True" AllowSorting="True" 
